...
const GetStarted = () => {
  ...
  const validateForm = () => {
    ...
    if (!verified) newErrors.captcha = "Please complete the CAPTCHA.";
    setErrors(newErrors);
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col sm:flex-row">
      ...
      <div className="hidden sm:block sm:w-[40%]">
        <div className="h-[300px] mt-[100px] py-4 px-16">
          <h1 className="text-[80px] font-bold text-[#60A5FA] mt-2">
            Get started!
          </h1>
          <p className="mt-4 text-lg">
            This is your first step to becoming fresh! Fill out the following
            questions as best as you can, and we’ll be in touch to get started.
          </p>
        </div>
      </div>

      {/* Right Section */}
      <div className="w-full sm:w-[60%] px-4">
        <form onSubmit={handleSubmit} className="space-y-8">
          <div>
            <h1 className="text-5xl text-white">About you</h1>
            <p className="mt-4 text-lg">Let’s start with the basics!</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
              <input
                ...
                value={formData.name}
                onChange={handleChange}
                className="h-14 bg-black rounded-xl border-white border-2 text-white p-4"
              />
              {errors.name && (
          ...
          {/* Services */}
          <div>
            <h1 className="text-5xl text-white">What services do you need?</h1>
          ...
          <button
            type="submit"
            className={`w-full h-14 rounded-xl text-xl font-bold ${
              verified
